 ...
 */
export declare function runConcurrentHTTPProcessesAndPathForwardTraffic(portNumber: number | undefined, proxyTargets: ReverseHTTPProxyTarget[], additionalProcesses: OutputProcess[]): Promise<void>;
